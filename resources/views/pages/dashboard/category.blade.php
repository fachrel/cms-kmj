    ...
    <section class="p-5 bg-white dark:bg-gray-800 rounded-lg mb-10">
        ...
        <form action="/category" method="POST">
            ...
            <div class="mb-6">
              ...
              <input type="text" id="kategori" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="kategori" required>
            </div>
