    ...
    <div class="container px-6 py-10 mx-auto">
        <div class="lg:flex lg:items-center lg:-mx-10">
            <div class="lg:w-1/2 lg:mx-10">
                <h1 class="text-2xl font-semibold text-gray-800 capitalize dark:text-white lg:text-3xl">Kontak Kami</h1>

                <p class="mt-4 text-gray-500 dark:text-gray-400">
                    Kita akan senang dapat mendengar dari anda
                </p>
                ...
                <form class="mt-12">
                    ...
                    <button class="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-green-500 rounded-md hover:bg-green-400 focus:outline-none focus:ring focus:ring-green-300 focus:ring-opacity-50">
                        Kirim
                    </button>
                </form>
            </div>
            ...
            <div class="mt-12 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10">
                <img class="hidden object-cover mx-auto lg:block shrink-0 w-96 h-96" src="{{url('/img/assets/logo/logo-kmj-1.png')}}" alt="">
