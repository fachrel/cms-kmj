...
@section('content')
        ...
        <div class="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
            <div class="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
                <div class="md:5/12 lg:w-5/12">
                    <img src="{{ url('/img/logo-kmj-original.png') }}" alt="image" loading="lazy" width=""
                        height="">
                </div>
                <div class="md:7/12 lg:w-6/12">
                    <h2 class="text-2xl text-gray-900 font-bold md:text-4xl">Tentang Khitan Modern Jogja</h2>
                    <p class="mt-6 text-gray-600">KHITAN MODERN JOGJA adalah cabang ke 3 pusat layanan khitan dengan
                        metode-metode
        ...
        <div class="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
            <div class="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
                <div class="md:7/12 lg:w-6/12">
                    ...
                    <p class="mt-6 text-gray-600">KHITAN MODERN JOGJA memiliki dokter-dokter profesional yang tersertifikasi
                        dan kompten
                ...
                <path fill="#22C55E" d="M55.5,-15.4C63.7,7.5,56.7,38,37.8,51.7C18.8,65.4,-12.1,62.3,-35.6,46C-59,29.7,-74.9,0.1,-67.8,-21.3C-60.6,-42.7,-30.3,-55.9,-3.4,-54.8C23.6,-53.8,47.2,-38.4,55.5,-15.4Z" transform="translate(100 100)" />
                    ...
                    <img src="{{ url('img/assets/dokter/doctor-with-mascot-cloud.png') }}" class="z-20" alt="image"
    ...
    <section class="bg-white bg-cover sm:bg-contain" style="background-image: url('/img/circle-scatter.svg')">
        <div class="container px-6 py-8 mx-auto">
            <h2 class="text-2xl font-semibold text-center text-gray-800 capitalize lg:text-3xl dark:text-white">Dokter Kami
            </h2>

            <div class="grid mt-8 sm:grid-cols-2 md:gap-8 lg:grid-cols-3 xl:grid-cols-4">
                <div class="w-full max-w-xs text-center">
                    <img class="w-full h-3/4 object-cover mx-auto rounded-lg" src="{{ url('/img/syamsul-arifin.jpeg') }}"
                        alt="avatar" />
                ...
                <div class="w-full max-w-xs text-center">
                    <img class="w-full h-3/4 object-cover mx-auto rounded-lg" src="{{ url('/img/encep.jpeg') }}"
                        alt="avatar" />
                ...
                <div class="w-full max-w-xs text-center">
                    <img class="w-full h-3/4 object-cover mx-auto rounded-lg" src="{{ url('/img/yayu.jpeg') }}"
                        alt="avatar" />
                ...
                <div class="w-full max-w-xs text-center">
                    <img class="w-full h-3/4 object-cover mx-auto rounded-lg" src="{{ url('/img/hana.jpeg') }}"
                        alt="avatar" />
    ...
    <section class="bg-white mb-20">
        <div class="max-w-6xl px-6 py-10 mx-auto">
            <main class="relative z-20 w-full mt-8 md:flex md:items-center xl:mt-12">
                ...
                <div
                    class="w-full p-6 bg-green-400 md:flex md:items-center rounded-2xl md:bg-transparent md:p-0 lg:px-12 md:justify-evenly">
                    <img class="h-24 w-24 md:mx-6 rounded-full object-cover shadow-md md:h-[32rem] md:w-80 lg:h-[36rem] lg:w-[26rem] md:rounded-2xl"
                        src="{{ url('img/assets/dokter/dr-encep-nobg.jpeg') }}" alt="client photo" />
                    ...
                    <div class="mt-2 md:mx-6">
                        ...
                        <p class="mt-4 text-lg leading-relaxed text-white md:text-xl"> “KHITAN bukan hanya sekedar potong
                            kulit kulup, namun lebih jauh dari itu melibatkan
